...
public class RunnableExample02 implements Runnable {
    String name;

    RunnableExample02(String name) {
        this.name = name;
    }
    ...
    public static void main(String[] args) {
        ...
        Runnable one = new RunnableExample02("영희");
        Thread thread = new Thread(one);

        Runnable two = new RunnableExample02("철수");
